<template>
  <footer class="footer-container">
    <div class="container">
      <a href="#" class="footer__logo | text-center">
        <svg width="148" height="25" xmlns="http://www.w3.org/2000/svg">
          <g fill="none" fill-rule="evenodd">
            ...
            />
            <g>
              <circle id="circle" cx="12.5" cy="12.5" r="12.5" />
              <path
                id="circle-path"
      ...
      <div class="footer__nav">
        <ul role="list">
          <li v-for="link in footerLinks" :key="link">
            <a href="#" class="fs-base text-up text-clr-900 text-center">
              {{ link }}
            </a>
          </li>
        </ul>
...
const footerLinks = ref(["Features", "Pricing", "Contact"]);
</script>
